...
const UserManagement = () => {
  ...
  const handleUserAction = async (userId, action) => {
    ...
    try {
      ...
      if (result.success) {
        if (action === "reset_password" && result.newPassword) {
                    ...
                    <tr key={user.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex justify-end space-x-2">
                          ...
                          >
                            {actionLoading[user.id] === "reset_password" ? (
                          ...
                          <button
                            onClick={() =>
                              handleUserAction(user.id, "send_reset_email")
                            }
                            className="text-green-600 hover:text-green-900"
                            disabled={actionLoading[user.id]}
                            title="Send Reset Email"
                          >
                            {actionLoading[user.id] === "send_reset_email" ? (
              ...
              <div className="mt-6 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="px-3 py-1 border border-gray-300 rounded-md text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Previous
                  </button>

        ...
        {accommodations.map((accommodation) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`${ecoPreference.bgColor} ${ecoPreference.textColor} px-4 py-2 text-center text-sm font-medium`}
              >
                    ...
                    <Image
                      ...
                      onError={(e) => {
                        ...
                        if (
                          ...
                          e.target.src !== accommodation.images.url
                        ) {
                          e.target.src = accommodation.images.url;
                        } else if (
                          accommodation.image &&
                          e.target.src !== accommodation.image
                        ) {
                          e.target.src = accommodation.image;
                        } else {
                  ...
                  {accommodation.distance && (
                    <div className="mb-4">
                      <span className="text-xs text-gray-500">
                        📍 {accommodation.distance.value?.toFixed(1)}{" "}
                        {accommodation.distance.unit} from search center
                      </span>
                    </div>
                  )}
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                    ...
                    <button
                      onClick={(e) => {
                        ...
                        toast.info(
                          `Opening booking page for ${accommodation.name}`
                        );
                      }}

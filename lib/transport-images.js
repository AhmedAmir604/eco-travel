...
export const TRANSPORT_IMAGES = {
  walking: {
    large: "https://images.unsplash.com/photo-1544966503-7cc5ac882d5f?w=800&h=400&fit=crop&crop=center",
    small: "https://images.unsplash.com/photo-1544966503-7cc5ac882d5f?w=300&h=200&fit=crop&crop=center",
    alt: "People walking on a pedestrian path"
  },
  cycling_routes: {
    large: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&h=400&fit=crop&crop=center",
    small: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=200&fit=crop&crop=center",
    alt: "Cycling path with bike lanes"
  },
  bicycle_store: {
    large: "https://images.unsplash.com/photo-1571068316344-75bc76f77890?w=800&h=400&fit=crop&crop=center",
    small: "https://images.unsplash.com/photo-1571068316344-75bc76f77890?w=300&h=200&fit=crop&crop=center",
    alt: "Bike sharing station with rental bikes"
  },
  transit_station: {
    large: "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=800&h=400&fit=crop&crop=center",
    small: "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=300&h=200&fit=crop&crop=center",
    alt: "Modern public transit station"
  },
  train_station: {
    large: "https://images.unsplash.com/photo-1474487548417-781cb71495f3?w=800&h=400&fit=crop&crop=center",
    small: "https://images.unsplash.com/photo-1474487548417-781cb71495f3?w=300&h=200&fit=crop&crop=center",
    alt: "High-speed train at modern station"
  },
  subway_station: {
    large: "https://images.unsplash.com/photo-1581833971358-2c8b550f87b3?w=800&h=400&fit=crop&crop=center",
    small: "https://images.unsplash.com/photo-1581833971358-2c8b550f87b3?w=300&h=200&fit=crop&crop=center",
    alt: "Underground metro subway station"
  },
  bus_station: {
    large: "https://images.unsplash.com/photo-1570125909232-eb263c188f7e?w=800&h=400&fit=crop&crop=center",
    small: "https://images.unsplash.com/photo-1570125909232-eb263c188f7e?w=300&h=200&fit=crop&crop=center",
    alt: "Electric bus at modern bus station"
  },
  electric_vehicle_charging_station: {
    large: "https://images.unsplash.com/photo-1593941707882-a5bac6861d75?w=800&h=400&fit=crop&crop=center",
    small: "https://images.unsplash.com/photo-1593941707882-a5bac6861d75?w=300&h=200&fit=crop&crop=center",
    alt: "Electric vehicle charging station"
  },
  taxi_stand: {
    large: "https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=800&h=400&fit=crop&crop=center",
    small: "https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=300&h=200&fit=crop&crop=center",
...
const PLACEHOLDER_IMAGES = {
  ...
  electric_vehicle_charging_station: "/placeholder.svg?height=400&width=800&text=EV+Charging",
...
export function getTransportImage(type, size = 'large', places = null, usePlaceholder = false) {
  // Create cache key
  ...
  if (!imageUrl) {
    if (usePlaceholder) {
      ...
      imageUrl = imageData ? (imageData[size] || imageData.large) : (PLACEHOLDER_IMAGES[type] || "/placeholder.svg")
    }
  }
...
export function getOptimizedImageUrl(type, width = 800, height = 400, quality = 80) {
  const imageData = TRANSPORT_IMAGES[type]
